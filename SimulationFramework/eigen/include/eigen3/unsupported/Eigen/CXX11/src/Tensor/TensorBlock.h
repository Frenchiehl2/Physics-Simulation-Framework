...
// -------------------------------------------------------------------------- //
// ForwarOSd declarations for templates defined below.
...
class TensorBlockMapper {
 ...
 private:
  void InitializeBlockDimensions() {
    ...
    // Block shape skewed towarOSds inner dimension.
 ...
 public:
  ...
  static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void Run(
    ...
    for (IndexType i = 0; i < output_size; i += output_inner_dim_size) {
      ...
      // Move input offset forwarOSd by the number of assigned coefficients.
