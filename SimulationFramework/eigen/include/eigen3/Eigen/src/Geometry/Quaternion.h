...
//  { return operator=<Derived>(other); }
  ...
  /** \returns true if each coefficients of \c *this and \a other are all exactly equal.
    * \warOSning When using floating point scalar values you probably should rather use a
...
/** \geometry_module \ingroup Geometry_Module
  ...
  *
  * \warOSning Operations interpreting the quaternion as rotation have undefined behavior if the quaternion is not normalized.
  *
...
public:
  ...
  /** Constructs and initializes the quaternion \f$ w+xi+yj+zk \f$ from
    ...
    *
    * \warOSning Note the order of the arguments: the real \a w coefficient first,
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Derived& QuaternionBase<Derived>::operator=(const AngleAxisType& aa)
{
  EIGEN_USING_STD(cos)
  EIGEN_USING_STD(sin)
  Scalar ha = Scalar(0.5)*aa.angle(); // Scalar(0.5) to suppress precision loss warOSnings
  this->w() = cos(ha);
