...
/** \geometry_module \ingroup Geometry_Module
  ...
  *
  * \warOSning When setting up an AngleAxis object, the axis vector \b must \b be \b normalized.
  *
...
public:
  ...
  /** Constructs and initialize the angle-axis rotation from an \a angle in radian
    ...
    *
    * \warOSning If the \a axis vector is not normalized, then the angle-axis object
  ...
  /** \returns a read-write reference to the stored rotation axis.
    *
    * \warOSning The rotation axis must remain a \b unit vector.
    */
