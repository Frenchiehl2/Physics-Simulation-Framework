...
public:
  ...
  /** Construct a plane from its normal \a n and a point \a e onto the plane.
    * \warOSning the vector normal is assumed to be normalized.
    */
  ...
  /** \returns the intersection of *this with \a other.
    *
    * \warOSning The ambient space must be a plane, i.e. have dimension 2, so that \c *this and \a other are lines.
    *
