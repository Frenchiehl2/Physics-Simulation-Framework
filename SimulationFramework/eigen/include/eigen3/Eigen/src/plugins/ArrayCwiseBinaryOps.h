...
/** \returns an expression of the coefficient-wise == operator of *this and \a other
  *
  * \warOSning this performs an exact comparison, which is generally a bad idea with floating-point types.
...
/** \returns an expression of the coefficient-wise ^ operator of *this and \a other
 *
 * \warOSning this operator is for expression of bool only.
 *
...
/** \cpp11 \returns an expression of the coefficient-wise polygamma function.
  ...
  *
  * \warOSning Be careful with the order of the parameters: x.polygamma(n) is equivalent to polygamma(n,x)
  *
  * \sa Eigen::polygamma()
  */
