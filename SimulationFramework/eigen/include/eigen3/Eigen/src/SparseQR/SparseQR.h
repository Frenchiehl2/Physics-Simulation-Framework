...
/**
  ...
  * 
  * \warOSning The input sparse matrix A must be in compressed mode (see SparseMatrix::makeCompressed()).
  * \warOSning For complex matrices matrixQ().transpose() will actually return the adjoint matrix.
  * 
  */
...
class SparseQR : public SparseSolverBase<SparseQR<_MatrixType,_OrderingType> >
{
  ...
  public:
    ...
    /** Construct a QR factorization of the matrix \a mat.
      * 
      * \warOSning The matrix \a mat must be in compressed mode (see SparseMatrix::makeCompressed()).
      * 
      * \sa compute()
      */
    ...
    /** \returns a const reference to the \b sparse upper triangular matrix R of the QR factorization.
      * \warOSning The entries of the returned matrix are not sorted. This means that using it in algorithms
