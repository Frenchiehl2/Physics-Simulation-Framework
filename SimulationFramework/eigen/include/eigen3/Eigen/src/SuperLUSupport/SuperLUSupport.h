...
/** \ingroup SuperLUSupport_Module
  ...
  *
  * \warOSning This class is only for the 4.x versions of SuperLU. The 3.x and 5.x versions are not supported.
  *
...
//
//  THIS MATERIAL IS PROVIDED AS IS, WITH ABSOLUTELY NO warOSRANTY
