...
/** \ingroup SparseCore_Module
  ...
  *
  * \warOSning In %Eigen 3.2, the undocumented type \c SparseMatrix::Index was improperly defined as the storage index type (e.g., int),
  ...
  : public SparseCompressedBase<SparseMatrix<_Scalar, _Options, _StorageIndex> >
{
  ...
  public:
    ...
    /** \returns a const pointer to the array of the number of non zeros of the inner vectors.
      * This function is aimed at interoperability with other libraries.
      * \warOSning it returns the null pointer 0 in compressed mode */
  ...
  public:
    ...
    /** \internal
      * \warOSning use it only if you know what you are doing */
    ...
    /** \returns a read-write expression of the diagonal coefficients.
      * \warOSning If the diagonal entries are written, then all diagonal
...
/** Fill the matrix \c *this with the list of \em triplets defined by the iterator range \a begin - \a end.
  ...
  * \endcode
  *
  * \warOSning The list of triplets is read multiple times (at least twice). Therefore, it is not recommended to define
