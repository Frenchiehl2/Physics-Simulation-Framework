...
//       EIGEN_INITIALIZE_COEFFS_IF_THAT_OPTION_IS_ENABLED
    ...
    /** \brief Construct a row of column vector with fixed size from an arbitrary number of coefficients. \cpp11
      ...
      *
      * \warOSning To construct a column (resp. row) vector of fixed length, the number of values passed to this
  ...
  public:
    ...
    /** \internal
      * \brief const version forwarOSded to DenseBase::swap
      */
    template<typename OtherDerived>
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
  ...
  public:
    ...
    // for EIGEN_MAX_ALIGN_BYTES==0, AlignedMax==Unaligned, and many compilers generate warOSnings for friend-ing a class twice.
