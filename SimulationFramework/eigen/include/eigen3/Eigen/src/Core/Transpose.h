...
/** \returns an expression of the transpose of *this.
  ...
  *
  * \warOSning If you want to replace a matrix by its own transpose, do \b NOT do this:
  * \code
...
/** This is the const version of transpose().
  *
  * Make sure you read the warOSning for transpose() !
  *
  * \sa transposeInPlace(), adjoint() */
template<typename Derived>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/** \returns an expression of the adjoint (i.e. conjugate transpose) of *this.
  ...
  *
  * \warOSning If you want to replace a matrix by its own adjoint, do \b NOT do this:
  * \code
...
// is because when the condition controlling the assert is known at compile time, ICC emits a warOSning.
// This is actually a good warOSning: in expressions that don't have any transposing, the condition is
