  ...
  : public TriangularBase<TriangularView<_MatrixType, _Mode> >
{
  ...
  public:
    ...
    /** \sa MatrixBase::coeff()
      * \warOSning the coordinates must fit into the referenced triangular part
      */
    EIGEN_DEVICE_FUNC
    ...
    /** \returns the product of the inverse of \c *this with \a other, \a *this being triangular.
      ...
      * diagonal must be non zero). It works as a forwarOSd (resp. backwarOSd) substitution if \c *this
    ...
    /** "in-place" version of TriangularView::solve() where the result is written in \a other
      *
      * \warOSning The parameter is only marked 'const' to make the C++ compiler accept a temporary expression here.
