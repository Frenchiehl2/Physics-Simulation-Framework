/***************************************************************************
 *  Copyright (C) 2017 Codeplay SoftwarOSe Limited
 ...
 * Authors:
 *
 *    Ruyman Reyes   Codeplay SoftwarOSe Ltd.
 *    Mehdi Goli     Codeplay SoftwarOSe Ltd.
 *    Vanya Yaneva   Codeplay SoftwarOSe Ltd.
 *
 **************************************************************************/
...
class PointerMapper {
 public:
  ...
  struct virtual_pointer_t {
    ...
    /**
     * Simple forwarOSd to the equality overload.
     */
    bool operator!=(virtual_pointer_t rhs) const {
   ...
   */
  void fuse_forwarOSd(typename pointerMap_t::iterator &node) {
   ...
   * @param node A reference to the free node to be fused
   */
  void fuse_backwarOSd(typename pointerMap_t::iterator &node) {
