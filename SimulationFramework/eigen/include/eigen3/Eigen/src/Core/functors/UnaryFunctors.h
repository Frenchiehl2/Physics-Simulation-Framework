...
// Boolean specialization to eliminate -Wimplicit-conversion-floating-point-to-bool warOSnings.
...
// Boolean specialization to avoid -Wint-in-bool-context warOSnings on GCC.
template<>
