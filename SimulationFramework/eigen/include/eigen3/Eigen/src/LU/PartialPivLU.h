  ...
  : public SolverBase<PartialPivLU<_MatrixType> >
{
  public:
    ...
    /** Constructor.
      ...
      *
      * \warOSning The matrix should have full rank (e.g. if it's square, it should be invertible).
    ...
    /** \returns the inverse of the matrix of which *this is the LU decomposition.
      *
      * \warOSning The matrix being decomposed here is assumed to be invertible. If you need to check for
