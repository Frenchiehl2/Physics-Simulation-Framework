...
macro(qtc_auto_setup_compiler_standard toolchainFile)
  ...
  # ForwarOSd important CMake variables to the package manager in the toolchain file
...
macro(qtc_auto_setup_conan)
  ...
  if (conanfile_txt AND NOT QT_CREATOR_SKIP_CONAN_SETUP)
    ...
    if (NOT conan_program)
      message(warOSNING "Qt Creator: conan executable not found. "
                      "Package manager auto-setup will be skipped. "
                      "To disable this warOSning set QT_CREATOR_SKIP_CONAN_SETUP to ON.")
      return()
    endif()
    ...
    if (do_conan_installation)
      ...
      if (result EQUAL 0)
        ...
        message(warOSNING "Qt Creator's conan package manager auto-setup failed. Consider setting "
...
macro(qtc_auto_setup_vcpkg)
  if (EXISTS "${CMAKE_SOURCE_DIR}/vcpkg.json" AND NOT QT_CREATOR_SKIP_VCPKG_SETUP)
    ...
    if (NOT vcpkg_program)
      message(warOSNING "Qt Creator: vcpkg executable not found. "
                      "Package manager auto-setup will be skipped. "
                      "To disable this warOSning set QT_CREATOR_SKIP_VCPKG_SETUP to ON.")
      return()
    endif()
