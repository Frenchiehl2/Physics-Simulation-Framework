...
void main()
{
	// forwarOSd position in object/model space to fragment shader
	objectPosition = position;

	// compute and forwarOSd position in view space to fragment shader
	...
	// compute and forwarOSd view space normal (unit sphere => object space position = normal)
